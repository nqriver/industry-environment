...
class WhetherApiClientTest {
    ...
    void shouldGetHistoricalTemperatureRecords() {
        ...
        // when
        var historicalTemp = whetherApiClient.getHistoricalMinMaxTemperatureMeasurements(new String[]{"temperature_2m_max", "temperature_2m_min"}, "52.52", "13.41", "2023-05-28", "2023-05-29", "auto");
